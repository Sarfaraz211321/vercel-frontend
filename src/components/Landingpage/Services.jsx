...
// const Services = () => {
//   return (
//     <section className="py-5 px-4" style={{ backgroundColor: "#f4f4f4" }}>
//       <div className="container">
//         {/* Left aligned small heading */}
//         <h5 className="text-danger fw-bold text-start">◆ Our Services</h5>

//         {/* Center aligned bold main heading */}
...
//             </h4>
//             <p className="text-muted small" style={{ lineHeight: "1.6", fontWeight: "500" }}>
...
//     <section className="py-5 px-4" style={{ backgroundColor: "#f4f4f4" }}>
//       <div className="container">
//         <h5 className="text-danger fw-bold">◆ Our Services</h5>
//         <h2 className="text-center fw-bold mb-5">Our Main Focus</h2>
//         <div className="row justify-content-center gap-4">
//           <div className="col-md-3 bg-white p-4 rounded shadow text-center service-card">
//             <i className="ri-home-4-line fs-1 text-danger mb-3"></i>
